...
[Novela](https://novela.narative.co/) is a Gatsby theme built by the team at [Narative](https://www.narative.co/), and built for everyone that loves the web™️. It includes multiple homepage layouts, built-in social sharing and a dark mode.
